...
You are extracting a unified log query for correlating events by trace id.
Timezone context: {{TIMEZONE}}.
Known services: {{KNOWN_SERVICES}}.
Known environments: {{KNOWN_ENVIRONMENTS}}.
Rules:
- Extract trace id (and optional span id). If present, add a tag like "trace_id:<value>" into Query.Tags.
